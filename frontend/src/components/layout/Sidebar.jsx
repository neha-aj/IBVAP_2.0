...
import { LayoutDashboard, MonitorPlay, Video, BellRing, History, ChartNoAxesCombined, CarFront, UserRound, Settings, X } from 'lucide-react';
...
export default function Sidebar({open=false,onClose=()=>{}}){
  ...
  const groups=[{label:'Overview',items:[['Dashboard','/',LayoutDashboard]]},{label:'Surveillance',items:[['Live Surveillance','/surveillance',MonitorPlay],['Cameras','/cameras',Video],['Alerts','/alerts',BellRing,activeAlertCount||undefined],['Events','/events',History]]},{label:'Investigation',items:[['License Plates','/anpr',CarFront],['Person & Vehicle Search','/reid',UserRound]]},{label:'Analytics',items:[['Analytics','/analytics',ChartNoAxesCombined]]},{label:'System',items:[['Settings','/settings',Settings]]}];
