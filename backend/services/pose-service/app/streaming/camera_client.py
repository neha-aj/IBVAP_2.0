...
direct cross-schema DB read (IG §6), same reasoning and same shape as
fire-smoke-service's own `camera_client.py`. This service only needs the id
list (to know which cameras to spawn `FrameConsumer`s for)."""
